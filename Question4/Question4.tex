...
States and, strikingly, India. Each film tradition has a signature, with
India leaning on drama and romance and running a full half hour longer
than an American film, Japan reaching for action, and the United States
and Britain heavy with documentaries. A reading of the descriptions
confirms these signatures in the words each genre reaches for. The
ratings tell a cautionary tale for a would-be rival, since the genres
that draw the most viewers, thrillers and action, rate among the lowest,
while documentaries earn the highest scores and the smallest audiences.
Set against HBO, Netflix trades quality for breadth, its median film
scoring a full half point lower across every genre. The lesson for an
investor is that breadth fills a catalogue but curation earns the
ratings.
}
\end{abstract}
...
{\centering \includegraphics{Question4_files/figure-latex/catfig-1} 
...
States leads by a wide margin, with India a clear and surprising second
ahead of Britain and France. The presence of India this high is the
first sign that Netflix is not one catalogue but several national ones
stacked together.

\begin{figure}[H]

{\centering \includegraphics{Question4_files/figure-latex/ctryfig-1} 
...
{\centering \includegraphics{Question4_files/figure-latex/heatfig-1} 
...
whole, with nothing hand-picked. Thrillers speak of suspects and killers
and heists, romances of crushes and weddings, action of assassins and
heroes, and documentaries of footage and interviews. The text read
confirms the genre map and offers a would-be platform a ready vocabulary
for sorting and recommending its own library.
...
{\centering \includegraphics{Question4_files/figure-latex/ratefig-1} 
...
{\centering \includegraphics{Question4_files/figure-latex/lenfig-1} 
...
{\centering \includegraphics{Question4_files/figure-latex/hbofig-1} 
