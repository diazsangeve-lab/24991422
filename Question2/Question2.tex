...
{\centering \includegraphics{Question2_files/figure-latex/fig-persist-1} 
...
Fashion does not stop at the whole name, it reaches down to the opening
letter. Figure \ref{initialheat} maps the share of births starting with
each letter across the decades, and whole rows brighten and dim as
initials move in and out of favour. The turnover at the level of a
single letter mirrors the turnover in the names themselves, which is a
quiet confirmation that naming is governed by fashion almost everywhere
one looks.

\begin{figure}[H]

{\centering \includegraphics{Question2_files/figure-latex/initialheat-1} 

}

\caption{Share of births by opening letter, across decades.\label{initialheat}}\label{fig:initialheat}
\end{figure}

Length carries its own quiet history. Figure \ref{lenridges} stacks the
distribution of name length for each decade, weighted by births so the
ridges reflect babies rather than rare names. The weighted mean climbs
from about 5.7 letters through the middle of the century to roughly 6.2
in the 1980s and 1990s before easing back toward 5.9, so the long
American name was a late-century fashion that has since softened rather
than a permanent shift.

\begin{figure}[H]

{\centering \includegraphics{Question2_files/figure-latex/lenridges-1} 

}

\caption{Name length distribution by decade, births weighted.\label{lenridges}}\label{fig:lenridges}
\end{figure}
...
{\centering \includegraphics{Question2_files/figure-latex/fig-bubble-1} 
...
{\centering \includegraphics{Question2_files/figure-latex/fig-fade-1} 
...
{\centering \includegraphics{Question2_files/figure-latex/fig-dist-1} 
...
The spread of names is not only about which ones rise, it is about how
thinly births are spread across all of them. Figure \ref{concentration}
tracks the share of babies carrying one of the ten most popular names
each year, fitted with a linear trend. The concentration falls from
roughly nineteen percent in 1910 to under six percent by 2014, so
parents now draw from a far wider pool and the very top names command a
shrinking slice of each cohort.

\begin{figure}[H]

{\centering \includegraphics{Question2_files/figure-latex/concentration-1} 

}

\caption{Share of births held by the ten most popular names each year.\label{concentration}}\label{fig:concentration}
\end{figure}
...
{\centering \includegraphics{Question2_files/figure-latex/fig-billboard-1} 
...
{\centering \includegraphics{Question2_files/figure-latex/fig-hbo-1} 
...
{\centering \includegraphics{Question2_files/figure-latex/fig-event-1} 
